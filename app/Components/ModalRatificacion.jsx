...
const handleClickModal = (ratificacionesRef,setSelectedItems,setShowModalItems,datosRatificacion2) => {
   let selected = []
      ...
      <Modal show={showModalItems} onHide={handleClose}>
         ...
         <Modal.Body>
            {Object.values(datosRatificacion2).map((dato,index) => 
                ...
                <div className='form-check' key={dato.label} ref={(element) => {ratificacionesRef.current[index] = element}}>
                   <input className='form-check-input' type='checkbox' value='' defaultChecked={dato.isTrue}/>
         ...
         <Modal.Footer>
            <Button variant='primary' onClick={()=> handleClickModal(ratificacionesRef,setSelectedItems,setShowModalItems,datosRatificacion2)}>Aceptar</Button>
         </Modal.Footer>
            </Modal>
                  )
                  }
